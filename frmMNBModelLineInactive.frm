...
Begin VB.Form frmMNBModelLineInactive 
   ...
   Begin SizerOneLibCtl.ElasticOne ElasticOne1 
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   285
         Left            =   120
         Picture         =   "frmMNBModelLineInactive.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   16
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   300
         Left            =   480
         Picture         =   "frmMNBModelLineInactive.frx":0622
         Style           =   1  'Graphical
         TabIndex        =   15
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdFind 
         ...
         Height          =   300
         Left            =   1200
         Picture         =   "frmMNBModelLineInactive.frx":0BCC
         Style           =   1  'Graphical
         TabIndex        =   14
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   300
         Left            =   1560
         Picture         =   "frmMNBModelLineInactive.frx":1162
         Style           =   1  'Graphical
         TabIndex        =   13
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   300
         Left            =   1920
         Picture         =   "frmMNBModelLineInactive.frx":173C
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   300
         Left            =   2280
         Picture         =   "frmMNBModelLineInactive.frx":1D16
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   300
         Left            =   2640
         Picture         =   "frmMNBModelLineInactive.frx":22F0
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdList 
         ...
         Height          =   300
         Left            =   3060
         Picture         =   "frmMNBModelLineInactive.frx":28CA
         Style           =   1  'Graphical
         TabIndex        =   9
         TabStop         =   0   'False
         ToolTipText     =   "Model/Line Inactivity Flag Selection List"
         Top             =   120
         Width           =   300
      End
      Begin VB.CommandButton cmdHelp 
         ...
         Height          =   300
         Left            =   3420
         Picture         =   "frmMNBModelLineInactive.frx":2A54
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
         ToolTipText     =   "Help"
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   300
         Left            =   3780
         Picture         =   "frmMNBModelLineInactive.frx":2B56
         Style           =   1  'Graphical
         TabIndex        =   7
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   300
         Left            =   840
         Picture         =   "frmMNBModelLineInactive.frx":32B8
         Style           =   1  'Graphical
         TabIndex        =   6
         TabStop         =   0   'False
         Top             =   120
      ...
      Begin VB.TextBox txtMNBLine 
         ...
         Width           =   615
      End
      Begin VB.CheckBox chkMNBModelLineInActiveFlag 
         Caption         =   "Model Line Inactive Flag"
         Height          =   360
         Left            =   3300
         TabIndex        =   2
         Top             =   2175
   ...
   End
End
Attribute VB_Name = "frmMNBModelLineInactive"
...
Public mstrMNBModelLine As String

Private Sub chkMNBModelLineInActiveFlag_Click()
    ...
    blnObsolete = chkMNBModelLineInActiveFlag.Value
    If blnObsolete = mrsDatabase!Model_Line_inactive_flag Then
        Exit Sub
    End If
    
    If mrsDatabase!Model_Line_inactive_flag <> blnObsolete Then
        mblnRecChanged = True
        mrsDatabase!Model_Line_inactive_flag = chkMNBModelLineInActiveFlag.Value
    End If
...
PROC_ERR:
    Call ShowError(Me.Name, "chkModelLineInactiveFlag", _
...
Private Sub Form_Load()
    ...
    If Not gblnUpdate Then
        ...
        chkMNBModelLineInActiveFlag.Enabled = False
    End If
    
    ' Retrieve the data
    Call RetrieveData
    If mrsDatabase.RecordCount > 1 Then
        frmMNBModelLineInactiveDisplay.Show vbModal
    End If
...
Private Sub mnuViewFind_Click()
    ...
    ' Call the procedure to load the form to be used to find
    ' a specific Model/Line.
    frmMNBModelLineInactiveFind.Show vbModal
    ...
    With mrsDatabase
        If Not .EOF And Not .BOF Then
            ...
            If !Model_Line_inactive_flag Then
                chkMNBModelLineInActiveFlag.Value = 1
            Else
                chkMNBModelLineInActiveFlag.Value = 0
            End If
