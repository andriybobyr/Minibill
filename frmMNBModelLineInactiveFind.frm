VERSION 5.00
Begin VB.Form frmMNBModelLineInactiveFind 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MiniBill - Find MNB Model"
   ClientHeight    =   2775
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5460
   ...
   End
End
Attribute VB_Name = "frmMNBModelLineInactiveFind"
...
Private Sub cmdFind_Click()
    ...
    With frmMNBModelLineInactive.mrsDatabase
