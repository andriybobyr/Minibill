...
Begin VB.Form frmAreaLocation 
   Caption         =   "MiniBill - Area / Stocking Location Association"
   ClientHeight    =   6945
   ClientLeft      =   60
   ClientTop       =   630
   ClientWidth     =   8775
   ...
   Begin SizerOneLibCtl.ElasticOne ElasticOne1 
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   300
         Left            =   60
         Picture         =   "frmAreaLocation.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   300
         Left            =   420
         Picture         =   "frmAreaLocation.frx":05DA
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   300
         Left            =   780
         Picture         =   "frmAreaLocation.frx":0BB4
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   300
         Left            =   1140
         Picture         =   "frmAreaLocation.frx":118E
         Style           =   1  'Graphical
         TabIndex        =   9
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   300
         Left            =   2280
         Picture         =   "frmAreaLocation.frx":1768
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   300
         Left            =   1560
         Picture         =   "frmAreaLocation.frx":1ECA
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdHelp 
         ...
         Height          =   300
         Left            =   1920
         Picture         =   "frmAreaLocation.frx":2474
         Style           =   1  'Graphical
         TabIndex        =   3
         TabStop         =   0   'False
         ToolTipText     =   "Help"
   ...
   End
End
Attribute VB_Name = "frmAreaLocation"
...
Private Sub BuildChoices()
    ...
    If cboArea.ListCount > 0 Then
        strArea = arrstrArea(cboArea.ListIndex)
    End If
    ...
    With mrsDatabase
        ...
        If !stocking_area_id <> strArea Then
            .Find "stocking_area_id = '" & strArea & "'"
        End If
        
        ' Loop through the recordset while the  area is
        ' equal to the area provided.
        Do While Not .EOF
            
            ' If the stocking_area_Id is equal to the one selected..
            If mrsDatabase!stocking_area_id <> strArea Then
                Exit Do
            End If
...
PROC_ERR:
    Call ShowError(Me.Name, "ClearChoices", Err.Number, _
        Err.Description)
    GoTo PROC_EXIT
End Sub
...
Private Sub cbostocking_area_Change()
    cboFindFirst cboArea
End Sub

Private Sub cbostocking_area_GotFocus()
    cboArea.SelStart = 0
    cboArea.SelLength = Len(cboArea.Text)
End Sub

Private Sub cbostocking_area_KeyPress(KeyAscii As Integer)
    cboKeyPress cboArea, KeyAscii
End Sub
...
Private Sub cmdAdd_Click()
    ...
    ' fields.
    mrsDatabase.AddNew
    mrsDatabase!stocking_area_id = arrstrArea(cboArea.ListIndex)
...
Private Sub cmdRemove_Click()
    ...
    With mrsDatabase
        .MoveFirst
        ' Find the stocking_area_Id
        .Find "stocking_area_Id = '" & arrstrArea(cboArea.ListIndex) & "'"
...
Private Sub cmdClearAll_Click()
    ...
    intReturnValue = MsgBox("Are you sure????", vbYesNo, "Delete All Locations in Area")
...
Private Sub Form_Load()
    ...
    Call RetrieveAreaData
    Call RetrieveAreaLocationData
...
Private Sub lstSelected_Click()
    ...
    strLocationId = Mid(lstSelected.Text, 1, 15)
   
    ' Find the area code in the recordset and
    ' fill the fields with data.
    With mrsDatabase
        .MoveFirst
        If !stocking_area_id <> arrstrArea(cboArea.ListIndex) Then
            .Find "stocking_area_Id = '" & arrstrArea(cboArea.ListIndex) & "'"
        End If
...
Private Sub mnuViewFirst_Click()
    ...
    ' Set the area combo box to the first area.
    cboArea.ListIndex = 0
...
Private Sub mnuViewPrevious_Click()
    ...
    If cboArea.ListIndex > 0 Then
        cboArea.ListIndex = cboArea.ListIndex - 1
    Else
...
Private Sub mnuViewNext_Click()
    ...
    If cboArea.ListIndex < cboArea.ListCount - 1 Then
        cboArea.ListIndex = cboArea.ListIndex + 1
    Else
        cboArea.ListIndex = 0
    End If
...
Private Sub RetrieveAreaLocationData()
    ...
    With mrsDatabase
        ...
        .Source = "select * from v_prod_stocking_area_Location " & _
            "order by stocking_area_id asc, stocking_Location_id asc"
...
PROC_ERR:
    Call ShowError(Me.Name, "RetrieveAreaLocationData", Err.Number, _
        Err.Description)
    GoTo PROC_EXIT
End Sub
...
Private Sub RetrieveAreaData()
    ' Purpose:  Instantiate and open the recordset.
    
    ' Set up error handling
    On Error GoTo PROC_ERR
    
    ' Declare Recordset to hold area
    ...
    With rsArea
        ...
        .CursorType = adOpenStatic
        ' Change the literal below to the name of your view
        .Source = "select * from v_prod_stocking_area order by stocking_area_description asc"
        '.LockType = adLockBatchOptimistic
    ...
    If rsArea.EOF Then
        MsgBox "No areas have been set up.  Please use the Area Maintenace table to set up valid areas."
        GoTo PROC_EXIT
    End If
    ...
    ' Area ID
    intIndex = 0
    ReDim arrstrArea(rsArea.RecordCount - 1)
    With rsArea
        ' Loop through the file
        Do While Not .EOF
            cboArea.AddItem Trim(rsArea!stocking_area_description)
            arrstrArea(intIndex) = rsArea!stocking_area_id
            .MoveNext
            intIndex = intIndex + 1
        Loop
        .Close
...
PROC_ERR:
    Call ShowError(Me.Name, "RetrieveAreaData", Err.Number, _
        Err.Description)
    GoTo PROC_EXIT
End Sub
