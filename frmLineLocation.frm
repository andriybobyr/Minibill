...
Begin VB.Form frmLineLocation 
   ...
   Begin SizerOneLibCtl.ElasticOne ElasticOne1 
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   300
         Left            =   60
         Picture         =   "frmLineLocation.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   300
         Left            =   420
         Picture         =   "frmLineLocation.frx":05DA
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   300
         Left            =   780
         Picture         =   "frmLineLocation.frx":0BB4
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   300
         Left            =   1140
         Picture         =   "frmLineLocation.frx":118E
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   300
         Left            =   2280
         Picture         =   "frmLineLocation.frx":1768
         Style           =   1  'Graphical
         TabIndex        =   9
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   300
         Left            =   1560
         Picture         =   "frmLineLocation.frx":1ECA
         Style           =   1  'Graphical
         TabIndex        =   5
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdHelp 
         ...
         Height          =   300
         Left            =   1920
         Picture         =   "frmLineLocation.frx":2474
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
         ToolTipText     =   "Help"
