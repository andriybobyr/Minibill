...
Begin VB.Form frmMNBModelLineStockLocNotesDisplay 
   BackColor       =   &H00FF8080&
   ...
   End
End
Attribute VB_Name = "frmMNBModelLineStockLocNotesDisplay"
...
Private Sub Form_Load()
    ...
    ' Fill the data grid
    With TDBGrid1
        Set .DataSource = frmMNBModelLineStockLocNotes.mrsDatabase
