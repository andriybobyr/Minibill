...
Begin VB.Form frmLocationDisplay 
   BackColor       =   &H00FF8080&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MiniBill - Stocking Location Selection..."
   ClientHeight    =   5580
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6315
   ...
   Begin MSDataGridLib.DataGrid dgrdLocation 
      Height          =   4275
      Left            =   180
      TabIndex        =   0
      Top             =   180
      ...
      BeginProperty Column02 
         DataField       =   "line_stocking_location_obsoletet"
   ...
   End
End
Attribute VB_Name = "frmLocationDisplay"
...
Private Sub Form_Load()
    ...
    ' Fill the data grid
    With dgrdLocation
        Set .DataSource = frmLocation.mrsDatabase
        gconDatabase.Errors.Clear
        .Columns(0).DataField = "stocking_location_id"
        .Columns(1).DataField = "stocking_location_description"
        .Columns(2).DataField = "stocking_location_obsolete_date"
        .ReBind
    End With
...
Private Sub dgrdLocation_DblClick()
